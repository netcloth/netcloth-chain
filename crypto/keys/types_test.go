...
func Test_writeReadLedgerInfo(t *testing.T) {
	...
	lInfo := newLedgerInfo("some_name", tmpKey, *hd.NewFundraiserParams(5, sdk.CoinType, 1))
	...
	assert.Equal(t,
		"nchpub1addwnpepqddddqg2glc8x4fl7vxjlnr7p5a3czm5kcdp4239sg6yqdc4rc2r56cc7zn",
