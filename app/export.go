...
func (app *NCHApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *NCHApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
