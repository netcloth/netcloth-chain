...
func (p *ProtocolV1) ExportAppStateAndValidators(ctx sdk.Context, forZeroHeight bool, jailWhiteList []string) (appState json.RawMessage, validators []tmtypes.GenesisValidator, err error) {
	if forZeroHeight {
...
func (p *ProtocolV1) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
