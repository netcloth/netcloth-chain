...
func NewMsgIPALNodeClaim(operator sdk.AccAddress, moniker, website, details, extension string, endpoints Endpoints, Bond sdk.Coin, test string) MsgIPALNodeClaim {
