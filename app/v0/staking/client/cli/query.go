...
Example:
$ %s query staking redelegation nch1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p nchvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm nchvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking redelegation nch1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`,
				version.ClientName,
			),
		),
