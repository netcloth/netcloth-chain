...
func TestSetValidator(t *testing.T) {
	...
	validator, _ = validator.AddTokensFromDel(valTokens, true)
...
func TestUpdateValidatorByPowerIndex(t *testing.T) {
	...
	validator, delSharesCreated := validator.AddTokensFromDel(sdk.TokensFromConsensusPower(100), true)
	require.Equal(t, sdk.Unbonded, validator.Status)
	...
	validator, burned := validator.RemoveDelShares(delSharesCreated.Quo(sdk.NewDec(2)), true)
...
func TestUpdateBondedValidatorsDecreaseCliff(t *testing.T) {
	...
	for i := 0; i < len(validators); i++ {
		...
		val, _ = val.AddTokensFromDel(delTokens, true)
	...
	nextCliffVal, _ = nextCliffVal.RemoveDelShares(shares.ToDec(), true)
...
func TestValidatorBasics(t *testing.T) {
	...
	for i, power := range powers {
		...
		validators[i], _ = validators[i].AddTokensFromDel(tokens, true)
	}
...
func TestGetValidatorsEdgeCases(t *testing.T) {
	...
	validators[0], _ = validators[0].AddTokensFromDel(delTokens, true)
	notBondedPool := keeper.GetNotBondedPool(ctx)
	...
	validators[3], _ = validators[3].AddTokensFromDel(sdk.TokensFromConsensusPower(1), true)
	...
	validators[3], _ = validators[3].RemoveDelShares(sdk.NewDec(201), true)
	...
	keeper.DeleteValidatorByPowerIndex(ctx, validators[3])
	validators[3], _ = validators[3].AddTokensFromDel(sdk.NewInt(200), true)
...
func TestValidatorBondHeight(t *testing.T) {
	...
	validators[0], _ = validators[0].AddTokensFromDel(tokens0, true)
	validators[1], _ = validators[1].AddTokensFromDel(tokens1, true)
	validators[2], _ = validators[2].AddTokensFromDel(tokens2, true)
	...
	validators[1], _ = validators[1].AddTokensFromDel(delTokens, true)
	validators[2], _ = validators[2].AddTokensFromDel(delTokens, true)
	validators[2] = TestingUpdateValidator(keeper, ctx, validators[2], true)
	resValidators = keeper.GetBondedValidatorsByPower(ctx)
...
func TestFullValidatorSetPowerChange(t *testing.T) {
	...
	validators[0], _ = validators[0].AddTokensFromDel(tokens, true)
	validators[0] = TestingUpdateValidator(keeper, ctx, validators[0], true)
	resValidators = keeper.GetBondedValidatorsByPower(ctx)
	assert.Equal(t, max, len(resValidators))
	assert.True(ValEq(t, validators[0], resValidators[0]))
...
func TestApplyAndReturnValidatorSetUpdatesMultipleValueChange(t *testing.T) {
	...
	validators[0], _ = validators[0].AddTokensFromDel(delTokens1, true)
	validators[1], _ = validators[1].AddTokensFromDel(delTokens2, true)
	validators[0] = TestingUpdateValidator(keeper, ctx, validators[0], false)
	validators[1] = TestingUpdateValidator(keeper, ctx, validators[1], false)
...
func TestApplyAndReturnValidatorSetUpdatesWithCliffValidator(t *testing.T) {
	...
	validators[2], _ = validators[2].AddTokensFromDel(tokens, true)
	keeper.SetValidator(ctx, validators[2])
	keeper.SetValidatorByPowerIndex(ctx, validators[2])
	updates = keeper.ApplyAndReturnValidatorSetUpdates(ctx)
	validators[2], _ = keeper.GetValidator(ctx, validators[2].OperatorAddress)
...
func TestApplyAndReturnValidatorSetUpdatesPowerDecrease(t *testing.T) {
	...
	validators[0], _ = validators[0].RemoveDelShares(delTokens1.ToDec(), true)
	validators[1], _ = validators[1].RemoveDelShares(delTokens2.ToDec(), true)
	validators[0] = TestingUpdateValidator(keeper, ctx, validators[0], false)
	validators[1] = TestingUpdateValidator(keeper, ctx, validators[1], false)
...
func TestApplyAndReturnValidatorSetUpdatesNewValidator(t *testing.T) {
	...
	validator := types.NewValidator(valAddr, valPubKey, types.Description{})
	validator, _ = validator.AddTokensFromDel(amt, true)

	keeper.SetValidator(ctx, validator)

	validator, _ = validator.RemoveDelShares(amt.ToDec(), true)
	keeper.SetValidator(ctx, validator)
	keeper.SetValidatorByPowerIndex(ctx, validator)
	...
	validator, _ = validator.AddTokensFromDel(tokens, true)
	keeper.SetValidator(ctx, validator)
	keeper.SetValidatorByPowerIndex(ctx, validator)
...
func TestApplyAndReturnValidatorSetUpdatesBondTransition(t *testing.T) {
	...
	keeper.DeleteValidatorByPowerIndex(ctx, validators[0])
	validators[0], _ = validators[0].RemoveDelShares(validators[0].DelegatorShares, true)
	keeper.SetValidator(ctx, validators[0])
	keeper.SetValidatorByPowerIndex(ctx, validators[0])
	updates = keeper.ApplyAndReturnValidatorSetUpdates(ctx)
	require.Equal(t, 0, len(updates))
	...
	validators[1], _ = validators[1].AddTokensFromDel(tokens, true)
	keeper.SetValidator(ctx, validators[1])
	keeper.SetValidatorByPowerIndex(ctx, validators[1])
