...
func TestDelegation(t *testing.T) {
	...
	for i, amt := range amts {
		...
		validators[i], _ = validators[i].AddTokensFromDel(amt, true)
	}
...
func TestUnbondDelegation(t *testing.T) {
	...
	validator, issuedShares := validator.AddTokensFromDel(startTokens, true)
...
func TestUndelegateFromUnbondedValidator(t *testing.T) {
	...
	validator, issuedShares := validator.AddTokensFromDel(valTokens, true)
...
func TestRedelegationMaxEntries(t *testing.T) {
	...
	validator2, issuedShares = validator2.AddTokensFromDel(valTokens, true)
	require.Equal(t, valTokens, issuedShares.RoundInt())
