...
// SetDelegatorWithdrawAddr - set the delegator withdraw address
...
// DeleteDelegatorWithdrawAddr - delete a delegator withdraw addr
...
// IterateDelegatorWithdrawAddrs - iterate over delegator withdraw addrs
...
// SetFeePool - set the global fee pool distribution info
...
// GetPreviousProposerConsAddr - get the proposer public key for this block
...
// GetDelegatorStartingInfo - get the starting info associated with a delegator
...
// SetDelegatorStartingInfo - set the starting info associated with a delegator
...
// HasDelegatorStartingInfo - check existence of the starting info associated with a delegator
...
// DeleteDelegatorStartingInfo - delete the starting info associated with a delegator
...
// IterateDelegatorStartingInfos - iterate over delegator starting infos
...
// GetValidatorHistoricalRewards - get historical rewards for a particular period
...
// SetValidatorHistoricalRewards - set historical rewards for a particular period
...
// IterateValidatorHistoricalRewards - iterate over historical rewards
...
// DeleteValidatorHistoricalReward - delete a historical reward
...
// DeleteValidatorHistoricalRewards - delete historical rewards for a validator
...
// DeleteAllValidatorHistoricalRewards - delete all historical rewards
...
// GetValidatorHistoricalReferenceCount - historical reference count (used for testcases)
...
// GetValidatorCurrentRewards - get current rewards for a validator
...
// SetValidatorCurrentRewards - set current rewards for a validator
...
// DeleteValidatorCurrentRewards - delete current rewards for a validator
...
// IterateValidatorCurrentRewards - iterate over current rewards
...
// GetValidatorAccumulatedCommission - get accumulated commission for a validator
...
// SetValidatorAccumulatedCommission - set accumulated commission for a validator
...
// DeleteValidatorAccumulatedCommission - delete accumulated commission for a validator
...
// IterateValidatorAccumulatedCommissions - iterate over accumulated commissions
...
// GetValidatorOutstandingRewards - get validator outstanding rewards
...
// SetValidatorOutstandingRewards - set validator outstanding rewards
...
// DeleteValidatorOutstandingRewards - delete validator outstanding rewards
...
// GetValidatorSlashEvent - get slash event for height
...
// SetValidatorSlashEvent - set slash event for height
...
// IterateValidatorSlashEventsBetween - iterate over slash events between heights, inclusive
...
// IterateValidatorSlashEvents - iterate over all slash events
...
// DeleteValidatorSlashEvents - delete slash events for a particular validator
...
// DeleteAllValidatorSlashEvents - delete all slash events
