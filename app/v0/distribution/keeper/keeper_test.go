...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec(sdk.NativeTokenName, sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	distrAcc.SetCoins(sdk.NewCoins(
		...
		sdk.NewCoin(sdk.NativeTokenName, sdk.NewInt(2)),
	))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin(sdk.NativeTokenName, expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin(sdk.NativeTokenName, expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec(sdk.NativeTokenName, sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
