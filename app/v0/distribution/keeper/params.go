...
func validateCommunityTax(i interface{}) error {
	v, ok := i.(sdk.Dec)
	if !ok {
		return fmt.Errorf("validateCommunityTax invalid parameter type: %T", i)
	}
...
func validateBaseProposerReward(i interface{}) error {
	v, ok := i.(sdk.Dec)
	if !ok {
		return fmt.Errorf("validateBaseProposerReward invalid parameter type: %T", i)
	}
...
func validateBonusProposerReward(i interface{}) error {
	v, ok := i.(sdk.Dec)
	if !ok {
		return fmt.Errorf("validateBonusProposerReward invalid parameter type: %T", i)
	}
...
func validateWithdrawAddrEnabled(i interface{}) error {
	_, ok := i.(bool)
	if !ok {
		return fmt.Errorf("validateWithdrawAddrEnabled invalid parameter type: %T", i)
	}
