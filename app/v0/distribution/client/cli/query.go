...
import (
	...
	"github.com/netcloth/netcloth-chain/app/v0/distribution/client/common"
...
Example:
$ %s query distr validator-outstanding-rewards nchvaloper1lwjmdnks33xwnmfayc64ycprww49n33mtm92ne
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission nchvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes nchvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards nch1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
$ %s query distr rewards nch1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p nchvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
