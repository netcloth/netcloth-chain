...
func TestNextInflation(t *testing.T) {
	...
	tests := []struct {
		...
		{sdk.ZeroDec(), sdk.NewDecWithPrec(10, 2), params.InflationRateChange.Quo(blocksPerYr)},
		...
		// test 10% minimum stop (testing with 100% bonded)
		{sdk.OneDec(), sdk.NewDecWithPrec(10, 2), sdk.ZeroDec()},
		{sdk.OneDec(), sdk.NewDecWithPrec(1000000001, 10), sdk.NewDecWithPrec(-1, 10)},
