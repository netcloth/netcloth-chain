...
contract UniswapFactory {
  ...
  function initializeFactory(address template) public {
    require(exchangeTemplate == address(0), "exchangeTemplate is null address");
    require(template != address(0), "template is null address");
  ...
  function createExchange(address token) public returns (address) {
    ...
    require(exchangeTemplate != address(0), "exchangeTemplate is null address");
    require(token_to_exchange[token] == address(0), "token_to_exchange is null");
