...
func GetSimulatorFlags() {
	...
	flag.IntVar(&FlagNumBlocksValue, "NumBlocks", 20, "number of new blocks to simulate from the initial block height")
	flag.IntVar(&FlagBlockSizeValue, "BlockSize", 100, "operations per block")
	...
	flag.BoolVar(&FlagVerboseValue, "Verbose", true, "verbose log output")
