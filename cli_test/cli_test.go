...
func TestNchCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	require.Equal(t, "nch1qcfdf69js922qrdr4yaww3ax7gjml6pdds46f4", f.KeyAddress("test-recover").String())

	// Cleanup testing directories
	f.Cleanup()
}

func TestNchCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	require.Equal(t, "nch1qcfdf69js922qrdr4yaww3ax7gjml6pdds46f4", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "nch1pdfav2cjhry9k79nu6r8kgknnjtq6a7rykmafy", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "nch1909k354n6wl8ujzu6kmh49w4d02ax7qvlkv4sn", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "nch1v9plmhvyhgxk3th9ydacm7j4z357s3nhtwsjat", f.KeyAddress("test-recoverH4").String())

	// Cleanup testing directories
	f.Cleanup()
}

func TestNchCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start nchd server with minimum fees
...
func TestNchCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start nchd server with minimum fees
	minGasPrice, _ := sdk.NewDecFromStr("0.000006")
	proc := f.NCHStart(fmt.Sprintf("--minimum-gas-prices=%s", sdk.NewDecCoinFromDec(feeDenom, minGasPrice)))
	defer proc.Stop(false)
...
func TestNchCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.CreateCodec()
	...
	genFile := filepath.Join(f.NchdHome, "config", "genesis.json")
...
func TestNchCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestNchCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.NchcliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestNchdCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestNchdAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
