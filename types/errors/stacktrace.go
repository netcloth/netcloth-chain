...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/netcloth/netcloch-chain/types/errors.Wrap",
		"github.com/netcloth/netcloch-chain/types/errors.Wrapf",
		"github.com/netcloth/netcloch-chain/types/errors.WithType",
