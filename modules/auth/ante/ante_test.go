...
func TestSimulateGasCost(t *testing.T) {
	...
	anteHandler := NewAnteHandler(app.AccountKeeper, app.SupplyKeeper, DefaultSigVerificationGasConsumer)
...
func TestCustomSignatureVerificationGasConsumer(t *testing.T) {
	...
	anteHandler := NewAnteHandler(app.AccountKeeper, app.SupplyKeeper, func(meter sdk.GasMeter, sig []byte, pubkey crypto.PubKey, params types.Params) error {
